...
--------------------------
-- ★ 제약조건 : INSERT, UPDATE 할 때, 제약조건에 맞는 데이터만 INSERT, UPDATE됨
...
-- DEFAULT 기본값 : 해당 열의 데이터를 입력하지 않으면 원래 NULL이 들어갈 것을 기본값이 들어가도록.

-- DEPT1 & EMP1 (exERD 이용하여 ERD 작성=테이블설계 -> DDL)
DROP TABLE DEPT1;
CREATE TABLE DEPT1(
    DEPTNO NUMBER(2),
...
SELECT * FROM STUDENT S, MAJOR M WHERE M.mCODE = S.mCODE;
